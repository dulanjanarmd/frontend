    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 xl:grid-cols-5">
        {STATUS_COLUMNS.map(col => {
          ...
          return (
            <div key={col} className="glass-card p-4 flex flex-col bg-slate-50/50 dark:bg-slate-900/50 min-h-[200px]">
              <h3 className="font-bold text-sm mb-4 flex items-center border-b border-border pb-3">
                ...
                {col}
                <span className="ml-auto text-xs font-medium text-slate-400 bg-white dark:bg-slate-900 px-1.5 py-0.5 rounded-full border border-border">
                  {colTasks.length}
                </span>
              </h3>
                  ...
                  colTasks.map((task, index) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="bg-white dark:bg-slate-950 p-3 rounded-lg shadow-sm border border-border cursor-pointer hover:shadow-md hover:border-primary/30 transition-all"
                      ...
                      >
                        ...
                        <h4 className="font-semibold text-sm text-slate-900 dark:text-slate-100 leading-tight mb-2">{task.title}</h4>
